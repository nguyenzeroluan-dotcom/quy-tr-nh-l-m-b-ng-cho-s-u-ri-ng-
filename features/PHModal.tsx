        ...
        <div className="space-y-6 pt-4 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-2 rounded-xl shadow-sm border border-gray-100">
                    <img src="https://agriplusvn.com/wp-content/uploads/2023/11/muc-do-phat-trien-cua-re-theo-pH.png" alt="Biểu đồ dinh dưỡng pH" className="w-full h-56 object-contain" />
                    <p className="text-center text-xs text-gray-500 mt-2 italic">Khả năng hấp thu dinh dưỡng theo độ pH</p>
                </div>
                 <div className="bg-white p-2 rounded-xl shadow-sm border border-gray-100">
                    <img src="https://baominhagri.com/upload/news/030023672419.jpg" alt="Tác động lên rễ" className="w-full h-56 object-cover rounded-lg" />
